...
<html>
    ...
    <body>
        ...
        <div id="show-dailyActivity" class="content scaffold-show" role="main">
            ...
            <f:display bean="dailyActivity" />
            <g:form resource="${this.dailyActivity}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.dailyActivity}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
